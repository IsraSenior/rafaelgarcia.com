          ...
          <div class="lg:col-span-3">
            <section class="container px-4 py-16 mx-auto sm:px-6 lg:px-8">
              <div class="max-w-3xl mx-auto">
                ...
                <h1 class="title title--headline">Talleres de Respiración Holotrópica</h1>
                <div class="mt-6 space-y-6 text-lg leading-relaxed content">
                  ...
                  <p>Durante los talleres, los participantes trabajan en parejas, alternando los roles de <b>“respirador”</b> y <b>“cuidador”</b>, siempre acompañados por facilitadores capacitados. El proceso incluye espacios de integración, como la pintura de mandalas, el compartir en grupo y el acompañamiento terapéutico cuando es necesario.</p>
                    ...
                    <div class="px-10 py-10 !text-white rounded-3xl bg-primary content my-16">
                      ...
                      <ul>
                        <li>Liberación emocional y corporal, desbloqueando tensiones y traumas.</li>
                        <li>Sanación de heridas profundas y resignificación del dolor.</li>
                        <li>Mayor claridad y propósito vital, conectando con lo que da sentido a la vida.</li>
                        <li>Expansión de la conciencia, más allá de los límites del ego y del cuerpo.</li>
                        <li>Integración personal y espiritual, favoreciendo equilibrio, creatividad y resiliencia.</li>
                      </ul>
                    </div>
    
                    <p>En <NuxtLink to="/servicios/camino-vital">Camino Vital</NuxtLink>, la Respiración Holotrópica ® es una herramienta clave dentro del
                      proceso integral
                      de transformación en las seis dimensiones del ser humano. Sin embargo, también está abierta a
                      quienes, sin participar en el programa completo, desean vivir una experiencia única de sanación y
                      crecimiento interior.</p>
                </div>
