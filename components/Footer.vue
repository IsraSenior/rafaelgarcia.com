...
<template>
    <footer class="bg-primary py-16">
        <div class="container mx-auto px-5 md:px-20">
            ...
            <div class="flex flex-col md:flex-row space-y-6 md:space-y-0 items-center justify-between pt-12 border-t border-muted/15">
                <p class="order-1 !text-white !text-base text-center md:text-left">Rafael García @ 2025 - Todos los derechos reservados</p>
                <div class="flex gap-x-5 order-2">
                    <NuxtLink to="/contacto" class="text-white hover:text-secondary-crecer">
